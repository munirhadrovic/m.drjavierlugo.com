...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1>Powered by <a href="http://www.mobilegrows.com" rel="external">MobileGrows</a> | <a href="http://drjavierlugo.com/" rel="external">Desktop Site</a></h1>
		...
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-b" id="findUS">
                      ...
                      <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                         <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Main</a>
                                 </div>
                                         </div>


                            <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                                <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Acne Center</a>
                                </div>
                            </div>
                            <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                                <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Cosmetics Procedures</a>
                                </div>
                            </div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Insurance & Patient Forms</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu" class="naziv">
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Main</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Acne Center</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Cosmetics Procedures</a></li>
                            <li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Insurance & Patient Forms</a></li>
